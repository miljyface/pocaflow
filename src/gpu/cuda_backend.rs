...
use cuda_sys::cuda::{
    CUcontext, CUdevice, CUstream, CUdeviceptr,
    cuInit, cuDeviceGet, cuCtxCreate_v2, cuStreamCreate,
    cuMemAlloc_v2, cuMemcpyHtoDAsync_v2, cuMemcpyDtoHAsync_v2,
    cuStreamSynchronize, cuStreamDestroy_v2, cuMemFree_v2, cuCtxDestroy_v2
};
use std::ptr;
use ndarray::Array2;
